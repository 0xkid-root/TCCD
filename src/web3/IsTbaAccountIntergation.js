...
import { TRADE_CATALYST_NFT } from "../contracts/contractAddress.js";
...
//       if(nft.contract.address === TRADE_CATALYST_NFT) {
//         const tokenId = nft.tokenId;
    
//         try {
//           const [firstAccountAddress, firstAccountExits]  = await getNFTAccount(client, TRADE_CATALYST_NFT, tokenId);
  ...
  try {
    ...
    for (const nft of nftsForOwner.ownedNfts) {
      if (nft.contract.address === TRADE_CATALYST_NFT) {
        ...
        try {
          const [accountAddress, accountExists] = await getNFTAccount(client, TRADE_CATALYST_NFT, tokenId);
